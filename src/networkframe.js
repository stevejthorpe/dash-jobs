...
(async () => {
    console.log("Inside comp getApplicationsData");
    axios.get("/allapplications").then(resp => {
        console.log("dataaaaa..", resp.data.rows);
        let data = resp.data.rows;
        console.log("COMP data: ", data);
        // let test = data.map(item => item);
